...
const revenuesController = require('./controllers/revenues');
...
/**
 * Dashboards app routes.
 */
app.get('/revenues/dashboard', revenuesController.getDashboard);
app.get('/shipping/dashboard', shippingController.getDashboard);
